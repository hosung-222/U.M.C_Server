...
public class EmailConfig {
    ...
    public JavaMailSender mailSender() {//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setUsername("umc.catholic@gmail.com");//구글계정을 넣습니다.
        mailSender.setPassword("filkyhnbhlsjykls");//구글 앱 비밀번호를 넣습니다.
    ...
    private Properties getMailProperties() {
        Properties properties  = new Properties();//JavaMail의 속성을 설정하기 위해 Properties 객체를 생성
